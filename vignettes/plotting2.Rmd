...
plot.new()
box()
abline(v = line2user(line = 2, side = 2), lty = "dashed", xpd = NA)
mtext("Side 2; Line 2", side = 2, line = 2)
```
...
par(mfrow = c(2, 2), oma = c(2, 1, 4, 1), mar = c(5, 4, 4, 2))
...
box(which = "inner", lwd = 4, col = "darkblue")
box(which = "outer", lwd = 4, col = "darkgreen")
labelLines(outer = TRUE, alpha = 0.5)
```

Rerun the above chunk changing `mfrow = c(2, 2)` to `mfcol = c(2, 2)` to note the difference.
