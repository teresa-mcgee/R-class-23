...
***
#### In class exercises
Make a list with appopriate list names that includes the following information about you: age, height (in inches), eye color, and hair color. 
...
***
#### In class exercises
Make a data frame with appopriate list names that includes the following information about you: age, height (in inches), eye color, and hair color. 
