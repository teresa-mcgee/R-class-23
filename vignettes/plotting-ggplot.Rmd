...
3. Make a bar chart of how many people are left or right handed using the `barplot()` function. Hint: `yeast$Handedness[yeast$Handedness=="Left"]` will return a vector including on those entries where `yeast$Handedness` is `"Left"` and `length()` will return the length of a vector. 
