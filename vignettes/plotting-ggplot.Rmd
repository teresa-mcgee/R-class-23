...
vignette: >
  %\VignetteIndexEntry{HTLTC-R: Plotting (ggplot2)}
...
Nearly all plots made using ggplot start with the function `ggplot`, this function allows you to specify a data frame that you want to use for your plot. You can also specify what you want to appear on each axis using the aes function. In this example, we want:
